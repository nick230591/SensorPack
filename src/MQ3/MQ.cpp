...
MQ::MQ(byte apin, byte dpin, GTimer *_timer)
{
    analog_pin = apin;
    digital_pin = dpin;
    timer = _timer;
...
//========================== GET ================================
bool MQ::get_start_calibrate() const
{
    return start_calibrate;
}

bool MQ::get_start_read() const
{
    return start_read;
}

float MQ::get_R0() const {
    return R0;
}

//========================== SET ================================

void MQ::set_start_calibrate(bool state)
{
    start_calibrate = state;
}

void MQ::set_start_read(bool state)
{
    start_read = state;
}
...
float MQ::read_Rs(float _value) const{
...
float MQ::convert_to_data(float _value) const
{
